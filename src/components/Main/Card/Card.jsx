  ...
  return (
    ...
    <animated.div
      ...
      onMouseMove={({ clientX, clientY }) => {
        ...
        const xys = [
          -(y - divRef.current.clientHeight / 2) / dampen, // rotateX
          (x - divRef.current.clientWidth / 2) / dampen, // rotateY
          1.5, // Scale
        ];
    ...
    >
      {/* <ContentCard capitalIMG={capitalIMG}/> */}
      <animated.div
      class={s.items}
      // onMouseLeave={() => {
      //   setProp({ xys: [0, 0, 1] });
      ...
      style={{
        ...
        // backgroundPosition: animatedProps.xys.interpolate((x, y, s) => `${x}% ${y}%`),
        transform: animatedProps.xys.interpolate(
